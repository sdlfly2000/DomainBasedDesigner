...
public class ActionGeneratorAgentTest
{
    ...
    public async Task Convert_ShouldReturnConvertedClasses_WhenValidInstructionIsProvided()
    {
        ...
        var instruction =
                ...
                ```mermaid
                    flowchart TB
                        subgraph main [Domain.User.UserService.UpsertUser]
                            ...
                            check1{Found?} --"no"-->
                            userNotFound["Create a User -> [IUserRepository.Create(User)]"] --> terminal     
                            check1 --"yes"--> 
            ...
            Only output full source code of **UserService.cs** in proper format, no other text. Use async/await correctly.
            """;
