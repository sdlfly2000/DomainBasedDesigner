...
- Create Angular project with ng: `ng new activator.domaindrivendesigner.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`activator.domaindrivendesigner.client.esproj`).
