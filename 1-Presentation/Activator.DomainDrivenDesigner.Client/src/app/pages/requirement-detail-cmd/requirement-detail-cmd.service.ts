...
import { AnalyzeRequirementsRequestModel, AnalyzeRequirementsResponseModel, SaveRequirementRequestModel, SaveRequirementResponseModel } from "./model/requirement-detail-cmd";
...
export class RequirementDetailCommandService {
    ...
    public SaveRequirement(request: SaveRequirementRequestModel): Observable<SaveRequirementResponseModel> {
        return this.httpClient.post<SaveRequirementResponseModel>(this.BaseUrl + "api/requirement/save", request, { headers: this.httpHeaders });
    }
}
